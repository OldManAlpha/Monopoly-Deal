...
import oldmana.general.md.server.card.action.CardActionCIA;
...
import oldmana.general.md.server.card.action.CardActionGeorgeWBush;
...
import oldmana.general.md.server.card.action.CardActionTSA;
...
public class BushDeck extends DeckStack
{
	@Override
	public void createDeck()
	{
		...
		for (int i = 0 ; i < 2 ; i++)
		{
			addCard(new CardActionGeorgeWBush());
		}
		//addCard(new CardActionPoliticalFavor());
		addCard(new CardPropertySaudiArabia());
		for (int i = 0 ; i < 3 ; i++)
		{
