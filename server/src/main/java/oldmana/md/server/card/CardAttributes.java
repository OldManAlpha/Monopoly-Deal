...
/**
 * All the default attribute names for cards.
 */
public class CardAttributes
{
	...
	public static final String MOVE_COST = "moveCost";
	public static final String CONSUME_MOVES_STAGE = "consumeMovesStage";
	public static final String MOVE_STAGE = "moveStage";
}
